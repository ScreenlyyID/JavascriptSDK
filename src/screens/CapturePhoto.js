                ...
                <div className='body column capture_photo'>
                    ...
                    <div className="capture_group">
                        ...
                        <div className='row wrapper capture_container'>
                            ...
                            <img alt='screenlyy' className={'capture'} src={require('../assets/video/scan_process.gif')} />

                            }
                            {this.props.sidesLeft === 1 &&
                                <img alt='screenlyy' className={'capture'} src={this.props.frontSubmitted ? require('../assets/images/card_back@3x.png') : require('../assets/images/illustration1@3x.png')} />
                            }
                        </div>
