...
class LowResolution extends Component {
                ...
                <div className='body column'>
                    ...
                    <div className='wrapper'>
                        ...
                        <div className='column description_container'>
                            ...
                            <p className='description'>Captured image is of low resolution.</p>
                        ...
                        <div className='instructions'>
                            ...
                            <ul>
                                <li>Ensure ID document is covering most of the camera view.</li>
                                <li>Ensure all edges of the document are clearly visible during capture</li>
                            ...
                            <div className='example_list'>
                                ...
                                <div className='example'>
                                    <img alt='screenlyy' className='image' src={require('../../assets/images/image_correct.jpg')}/>
                                    <div className="example_text">
                                        <img alt='screenlyy' className='icon' src={require('../../assets/images/icon_checked@2x.png')}/>
                                        <p>correct</p>
                                    </div>
                                </div>

                                <div className='example'>
                                    <img alt='screenlyy' className='image' src={require('../../assets/images/image_incorrect.jpg')}/>
                                    <div className="example_text">
                                        <img alt='screenlyy' className='icon' src={require('../../assets/images/icon_attention@2x.png')}/>
                                        <p>incorrect</p>
                                    </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(LowResolution);