                    ...
                    <div className='wrapper'>
                        ...
                        <div className='row results_id_sig'>
                            ...
                            <figure className='results_id'>
                                {this.props.resultData['Photo'].length > 0 && <img alt='screenlyy' className={'profile'} src={this.props.resultData['Photo']}/>}
                            </figure>

                            <figure className='results_sig'>
                                {this.props.resultData['Signature'].length > 0 && <img alt='screenlyy' className={'signature'} src={this.props.resultData['Signature']}/>}
                            </figure>
                        ...
                        <div className='results_data'>
                                ...
                                {this.props.sanctions !== null &&
                                <div className='row'>
                                    <div className='type'>Sanctions</div>
                                    <div className='data'>
                                        {this.props.sanctions}
                                    </div>
                                </div>
                                }
                        ...
                        <a className='btn outline' onClick={() => this.redirectToDone()}>
                            <p className={'buttonBgText'}>Next</p>
                        </a>
