                    ...
                    <div className='wrapper'>
                        ...
                        <div className='row results_id_sig'>
                            ...
                            <figure class='results_medcard'>
                                {this.props.resultData['FrontImage'] && this.props.resultData['FrontImage'].length > 0 && <img alt='screenlyy' className={'medical-card-front'} src={this.props.resultData['FrontImage']}/>}
                            </figure>

                            <figure class='results_medcard'>
                                {this.props.resultData['BackImage'] && this.props.resultData['BackImage'].length > 0 && <img alt='screenlyy' className={'medical-card-back'} src={this.props.resultData['BackImage']}/>}
                            </figure>
